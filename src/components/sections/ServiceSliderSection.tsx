...
import styles from "./ServiceSliderSection.module.css";
...
export function ServiceSliderSection({ slides = [] }: ServiceSliderSectionProps) {
  ...
  return (
    ...
    data-service-slider-section={1}>
      <div className={styles.content}>
        ...
        >
          {slides.map((slide, index) => (
            <SwiperSlide className={styles.slide} key={`${slide.text}-${index}`}>
              <div
