          ...
          <div className={styles.left}>
            ...
            {logo && (
              <Image
                ...
                width={logo.media_details?.width ?? 172}
                height={logo.media_details?.height ?? 120}
              />
            )}
            ...
            >
              ...
              <button
                className={`${styles.button} main-button-white`}
                type="submit"
                disabled={isSending}
              >
                <span>
          ...
          <div className={styles.right}>
            {image && (
              <Image
                ...
                alt={image.alt_text || ""}
                width={image.media_details?.width ?? 888}
                height={image.media_details?.height ?? 960}
              />
            )}
          </div>
        </div>
